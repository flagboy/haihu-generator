...
def create_sample_dataset():
    ...
    for i in range(10):  # 10フレームのサンプル
        ...
        # サンプル牌アノテーション
        tile_types = ["1m", "2m", "3m", "1p", "2p", "3p", "1s", "2s", "3s", "東", "南", "西", "北", "白", "發", "中"]
...
def demo_model_evaluation():
    ...
    print("\n2. サンプル学習履歴:")
    sample_history = [
        {"epoch": 0, "train_loss": 2.5, "val_loss": 2.3, "train_accuracy": 0.3, "val_accuracy": 0.35},
        {"epoch": 10, "train_loss": 1.8, "val_loss": 1.9, "train_accuracy": 0.6, "val_accuracy": 0.58},
        {"epoch": 20, "train_loss": 1.2, "val_loss": 1.4, "train_accuracy": 0.8, "val_accuracy": 0.75},
        {"epoch": 30, "train_loss": 0.8, "val_loss": 1.1, "train_accuracy": 0.9, "val_accuracy": 0.82},
        {"epoch": 40, "train_loss": 0.5, "val_loss": 1.0, "train_accuracy": 0.95, "val_accuracy": 0.85}
    ]
