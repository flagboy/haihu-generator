...
class PerformanceOptimizer:
    ...
    def get_current_metrics(self) -> PerformanceMetrics:
        ...
        try:
            ...
            return PerformanceMetrics(
                ...
                gpu_usage=None, gpu_memory=None,
    ...
    def optimize_batch_size(self, current_batch_size: int, 
                          processing_time: float, memory_usage: float) -> int:
        """バッチサイズを最適化"""
        try:
    ...
    def get_optimization_recommendations(self) -> List[str]:
        ...
        if latest_metrics.memory_usage > 85:
            recommendations.append("メモリ使用率が高いです。バッチサイズを減らすか、不要なデータを削除してください")
        ...
        if latest_metrics.memory_available < 1.0:  # 1GB未満
            recommendations.append("利用可能メモリが少ないです。他のアプリケーションを終了することを検討してください")
        
        # 履歴に基づく推奨
        if len(self.metrics_history) > 10:
            avg_cpu = np.mean([m.cpu_usage for m in self.metrics_history[-10:]])
            if avg_cpu > 70:
                recommendations.append("平均CPU使用率が高いです。システム設定の見直しを検討してください")
        ...
        try:
            ...
            summary = {
                ...
                'statistics': {
                    ...
                    'monitoring_duration': len(self.metrics_history) * self.optimization_config['monitoring_interval']
                },
                'optimizations_applied': self.optimizations_applied,
