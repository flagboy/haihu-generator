...
class TileDetector:
    ...
    def classify_tile_areas(self, image: np.ndarray, 
                          detections: List[DetectionResult]) -> Dict[str, List[DetectionResult]]:
        """
    ...
    def track_tile_movements(self, prev_detections: List[DetectionResult],
                           curr_detections: List[DetectionResult]) -> List[Tuple[DetectionResult, DetectionResult]]:
        """
        牌の移動を追跡
