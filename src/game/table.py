...
class Table:
    ...
    def draw_kan_tile(self) -> Optional[str]:
        """
        カン用の牌を王牌から取得
    ...
    def _get_next_tile(self, indicator: str) -> Optional[str]:
        """
        ドラ表示牌から実際のドラ牌を取得
    ...
    def __repr__(self) -> str:
        """詳細な文字列表現"""
        return (f"Table(round={self.get_current_round_name()}, honba={self.state.honba}, "
