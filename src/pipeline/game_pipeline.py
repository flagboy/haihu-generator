...
class GamePipeline:
    ...
    def initialize_game(self, player_names: dict[PlayerPosition, str] | None = None) -> bool:
        """
        ゲームを初期化
    ...
    def _validate_discarded_tiles(
        self, discarded_tiles: dict[str, list[str]]
    ) -> dict[str, list[str]]:
        """捨て牌データを検証"""
        validated_discards = {}
    ...
    def start_new_round(self, round_number: int, round_name: str, dealer: PlayerPosition) -> bool:
        """
        新しい局を開始
    ...
    def __repr__(self) -> str:
        """詳細な文字列表現"""
        return (
            f"GamePipeline(game_id='{self.game_id}', "
