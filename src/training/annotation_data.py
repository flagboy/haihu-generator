...
class BoundingBox:
    ...
    @classmethod
    def from_yolo_format(cls, center_x: float, center_y: float, width: float, height: float,
    ...
    def get_all_statistics(self) -> Dict[str, Any]:
        ...
        for annotation in self.video_annotations.values():
            ...
            for area, count in stats["area_distribution"].items():
                total_stats["area_distribution"][area] = total_stats["area_distribution"].get(area, 0) + count
            
            total_stats["quality_stats"].extend([frame.quality_score for frame in annotation.frames])
        ...
        total_stats["annotation_ratio"] = (
            ...
            if total_stats["total_frames"] > 0 else 0.0
        )
