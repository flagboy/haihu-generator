...
class MahjongSystemApp:
    ...
    def process_video(self, video_path: str, output_path: Optional[str] = None,
        ...
        try:
            ...
            self.logger.info(f"Success: {result['success']}, Quality Score: {result.get('quality_score', 'N/A')}")
    ...
    def batch_process(self, input_directory: str, output_directory: str,
        ...
        try:
            ...
            self.logger.info(f"Processed {len(video_files)} videos, Success rate: {batch_result.get('success_rate', 0):.2f}")
    ...
    def validate_record(self, record_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Validation completed. Score: {validation_result.get('overall_score', 'N/A')}")
    ...
    try:
        ...
        if args.command == 'process':
            ...
            if result.get('success', False):
                ...
                print(f"詳細: {json.dumps(result.get('details', {}), indent=2, ensure_ascii=False)}")
                return 0
            else:
