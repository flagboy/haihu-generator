...
class TestPerformanceOptimization:
    ...
    def test_cache_effectiveness(self):
        """キャッシュ効果テスト"""
        # キャッシュクリア
        self.formatter.cache_manager.clear()
    ...
    def test_cache_size_limit(self):
        ...
        # キャッシュサイズ制限を小さく設定
        original_limit = self.formatter.cache_manager._backend.max_size
        self.formatter.cache_manager._backend.max_size = 10
        ...
        try:
            ...
            cache_size = len(self.formatter.cache_manager._backend._cache)
            ...
            # 元の制限値に戻す
            self.formatter.cache_manager._backend.max_size = original_limit
