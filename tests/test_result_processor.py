...
class TestResultProcessor:
    ...
    def sample_game_data(self):
        ...
        game_data.to_tenhou_format.return_value = {
            ...
            "rounds": [{"round_number": 0, "actions": [["T0", "1m"], ["D0", "9m"], ["T1", "5p"]]}],
        }
        return game_data
    ...
    def test_optimize_tenhou_data(self, result_processor):
        ...
        data = {
            ...
            "empty_dict": {},
            "valid_field": "value",
            "nested": {"empty": None, "valid": "nested_value"},
            "rounds": [{"actions": [["D0", "1m"], ["D0", "2m"], ["D0", "3m"], ["T1", "5p"]]}],
        }
    ...
    def test_remove_empty_fields(self, result_processor):
        ...
        # 期待される結果
        assert result == {"a": "value", "f": {"g": "nested"}, "j": [1, 2, 3], "k": {"l": "value"}}
