...
class TestMemoryPerformance:
    ...
    def test_memory_leak_detection(self):
        ...
        assert memory_increase_ratio < 0.5, f"Potential memory leak detected: {memory_increase_ratio:.2%} increase"
...
""")
    ...
    def test_worker_scaling(self):
        ...
        for worker_count in worker_counts:
            ...
            assert processing_time < 2.0, f"Processing took too long with {worker_count} workers: {processing_time:.2f}s"
...
""")
        ...
        try:
            ...
            # 実際のAIPipelineをモック
            with patch('src.detection.tile_detector.TileDetector') as mock_detector, \
...
""")
        ...
        try:
            ...
            assert std_response_time < 0.05, f"Response time too inconsistent: {std_response_time:.3f}s std"
