...
from src.training.semi_auto_labeler import PredictionResult, SemiAutoLabeler
...
class TestTileAnnotation:
    ...
    def test_tile_annotation_creation(self):
        """牌アノテーションの作成テスト"""
        bbox = BoundingBox(10, 20, 100, 120)
        tile = TileAnnotation(tile_id="1m", bbox=bbox, confidence=0.9, area_type="hand")
...
class TestDatasetManager:
    ...
    def temp_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config_data = {
                "training": {"database_path": f"{temp_dir}/test.db", "dataset_root": temp_dir}
            }
