...
from src.training.learning.learning_scheduler import LearningScheduler, HyperParameter, OptimizationTrial
...
class TestModelEvaluator(TestLearningSystem):
    ...
    def test_learning_curves_creation(self):
        ...
        history = [
            ...
            {"epoch": 1, "train_loss": 1.5, "val_loss": 1.4, "train_accuracy": 0.5, "val_accuracy": 0.52},
            {"epoch": 2, "train_loss": 1.0, "val_loss": 1.1, "train_accuracy": 0.7, "val_accuracy": 0.68}
        ]
...
class TestIntegration(TestLearningSystem):
    ...
    def test_full_workflow_simulation(self):
        ...
        # サンプル履歴で学習曲線作成をテスト
        sample_history = [
            {"epoch": 0, "train_loss": 1.0, "val_loss": 1.1, "train_accuracy": 0.5, "val_accuracy": 0.48},
            {"epoch": 1, "train_loss": 0.8, "val_loss": 0.9, "train_accuracy": 0.7, "val_accuracy": 0.68}
        ]
