...
from src.detection.tile_detector import TileDetector, DetectionResult, SimpleCNN
...
class TestTileDetector:
    ...
    def test_classify_tile_areas(self, detector, sample_image):
        ...
        detections = [
            ...
            DetectionResult(bbox=(300, 400, 350, 450), confidence=0.9, class_id=0, class_name="tile")
        ]
    ...
    def test_track_tile_movements(self, detector):
        ...
        curr_detections = [
            DetectionResult(bbox=(110, 110, 160, 160), confidence=0.8, class_id=0, class_name="tile"),
            DetectionResult(bbox=(300, 300, 350, 350), confidence=0.9, class_id=0, class_name="tile")
        ]
